...
import { FiX, FiUpload, FiTrash2, FiVideo, FiCheck, FiAlertCircle, FiClock, FiZap } from "react-icons/fi";
  ...
  const handleVideoSelect = (file) => {
    if (file) {
      ...
      if (file.size > maxSize) {
        setError(t("videoUpload.fileTooLarge", "حجم الملف كبير جداً (الحد الأقصى 500 ميجابايت)"));
        return;
      }
